...
- Remote grade `315996` confirmed the candidate: 50/50 completed, zero failures, mean effective-compute ratio `0.0929`, raw final MSE `8.26e-6`, and adjusted score `8.26e-7`.  Compared with remote `315988` (`1.06e-6` adjusted at `0.0676`), adjusted score improved by 22.1%.
- The next bounded probe is `N=6,144`, batch 512.  Linear extrapolation projects a `0.1013` ratio; its expected score factor relative to N=5,632 is about `0.929` under inverse-sample error scaling.  This is an empirical probe, not a promised gain.
